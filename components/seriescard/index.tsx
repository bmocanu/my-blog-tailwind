/* 
  Post Series functionality copied from https://github.com/PxlSyl/tailwind-nextjs-starter-blog-i18n
  Please check PxlSyl's repository for other functionalities added on top of timlrx Tailwind theme
*/
